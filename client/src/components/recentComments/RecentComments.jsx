...
const RecentComments = ({user,contents}) => {
  ...
  const post_id = contents?.post_id._id;
  const post_name = contents?.post_id.title;
  ...
  <div className="comment-box__container">
      <div className="comments-list">
        ...
        <div className="comment comment--root">
          ...
          <div className='comment__to-post'>
            <p>Commented To </p>
            <Link to={'/posts/'+post_id}>{post_name}</Link>
          </div>
        </div>
      </div>
